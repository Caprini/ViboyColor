...
- ❌ **Escrituras No-Cero a VRAM**: No se detectaron escrituras no-cero a VRAM en ninguna de las 5 ROMs. Los juegos solo escriben ceros (0x00) a VRAM durante la ejecución
- ❌ **Secuencias de Tiles**: No se detectaron secuencias de tiles completos
- ❌ **Estado Periódico de VRAM**: VRAM permanece vacía (0 bytes no-cero) durante toda la ejecución en todas las ROMs
- 📊 **Estado Inicial de VRAM**: El estado inicial de VRAM tiene 95.49% de bytes no-cero, pero el juego los borra inmediatamente escribiendo ceros desde PC=0x36E3
...
**Próximos Pasos**:
- Investigar por qué los juegos no cargan tiles nuevos durante la ejecución
- Investigar cuándo se cargan los tiles iniciales
- Investigar el timing de borrado de datos iniciales
