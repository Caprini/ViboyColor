...
- Implementación en `src/viboy.py` que se activa cuando se detecta un write program a BUTTONS_SELECTED y mantiene START presionado hasta que se detecta un read program en BUTTONS_SELECTED o un write a NONE_SELECTED.
